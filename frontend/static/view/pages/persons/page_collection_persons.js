...
import {PageObjectPerson} from "./page_object_person.js";


export class PageCollectionPersons extends PageCollection {
    ...
    fetchElements(page, callback) {
        this.personRepository.listPersons(
            page,
    ...
    navigateToItem(item) {
        this.app.pushPage(new PageObjectPerson(this.app, item))
    }
}
